...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2">
      <?= Html::activeLabel($model, 'clave_trab', ['label'=>'TRABAJADOR:', 'class'=>'control-label']); ?>
    </div>
    <div class="col-lg-10 col-md-10 col-sm-10">
      <div class="col-lg-12 col-md-12">
          <?= $form->field($model, 'clave_trab', [
            'template'=>'<div class="row"><div class="col-lg-2 col-md-2 col-sm-2">{input}</div><div class="col-lg-8 col-md-8 col-sm-8"><div id="nombreTrab"></div></div></div><div class="row"><div class="col-lg-12 col-md-12">{error}{hint}</div></div>',
            'addon'=>[
              'append'=> [
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
        <?= Html::activeLabel($model, 'clave_plaza', ['label'=>'EN PLAZA:', 'class'=>'control-label']) ?>
    </div>
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
        <?= Html::activeLabel($model, 'clave_motivo', ['label' => 'AUSENCIA:', 'class' => 'control-label']) ?>
    </div>
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
       <?= Html::activeLabel($model, 'fec_inicio', ['label'=>'INICIA:', 'class'=>'control-label']) ?>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-3">
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
         <?= Html::activeLabel($model, 'fec_termino', ['label'=>'TERMINA:', 'class'=>'control-label']) ?>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-3">
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2">
        <?= Html::activeLabel($model, 'obs', ['label'=>'COMENTARIOS:', 'class'=>'control-label']) ?>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4">
